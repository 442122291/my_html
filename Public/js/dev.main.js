...
$(function(){
   ...
   $('#register_sub_btn').click(function(){	
	  ...
	  var pwd = checkform.checkPwd('register_pwd1','register_pwd2','register_pwd1_str','register_pwd2_str',"R##4-30");
	 if(email && pwd){
   ...
   $('#widgettest').click(function(){
    ...
    //    alert(_APP_ + "/Home/Comment/addComment");
        // ajax
        $.post(_APP_ + "/Home/Comment/addComment",
