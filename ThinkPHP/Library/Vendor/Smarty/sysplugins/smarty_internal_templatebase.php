...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data {
     ...
     * @param callback $callback   PHP callback to User
     ...
     * @param string $class_impl the referenced PHP class to User
    ...
    public function registerClass($class_name, $class_impl)
    {
        ...
        if (!class_exists($class_impl)) {
            throw new SmartyException("Undefined class '$class_impl' in User template class");
        }
        // User the class
