...
<div class="container">
    ...
    <div class="blog-header">
        <h3 class="blog-title">发布博文</h3>

    </div>
    <div class="row">
        <div class="col-sm-8 blog-main">
            <div class="blog-post">
            <form id='topic_form' name="addtopic" action="<?php echo U('Blog/add_Blog');?>" method="post">
                <h4>标题</h4>

                <input type="text" name="title" required autofocus>
                <h4>内容</h4>
                <textarea id="editor_id" name="content" class="form-control" required autofocus style="width:97%;height:400px;"></textarea>
                <button href="javascript:;" id="topic_sub_btn" class="btn btn-primary pull-right" style="margin-right: 18px;">发布博文</button><span></span>
            </form>
        </div>
