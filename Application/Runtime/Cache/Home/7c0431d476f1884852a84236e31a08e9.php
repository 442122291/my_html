...
<div class="blog-masthead">
    <div class="container">
        <nav class="blog-nav">
            ...
            <a class="blog-nav-item active" href='<?php echo U("Guestbook/guestbook");?>'>留言板</a>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-8 blog-main">
            ...
            <?php if(is_array($messages)): $i = 0; $__LIST__ = $messages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="blog-post">
                    <form action="<?php echo U('Guestbook/del_message?id',array('id'=>$vo['mes_id']));?>" method="post">
                    <p class="blog-post-meta"><?php echo ($vo["time"]); ?> by <?php echo ($vo["user"]); ?></p>
                    <p>留言：<?php echo ($vo["message"]); ?></p>
                    <button type="submit" class="btn">删除此留言</button>
                    </form>
