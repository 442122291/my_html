...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-8 blog-main">
            -------------------------------------------------------------------------------------------
            <div class="blog-post">
                <form class="form-signin" role="form" action='<?php echo U("Guestbook/post_message");?>' method="post">
                <input type="Guestbook" name="Guestbook" class="form-control" placeholder="有什么想对我说的嘛？" required autofocus>
